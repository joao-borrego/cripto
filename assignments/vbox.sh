...
VBoxManage modifyvm "machine1" --macaddress2 auto
...
VBoxManage modifyvm "machine2" --macaddress1 auto
...
VBoxManage modifyvm "machine2" --macaddress2 auto
...
VBoxManage modifyvm "machine2" --macaddress3 auto
...
VBoxManage modifyvm "machine3" --macaddress1 auto
...
VBoxManage modifyvm "machine4" --macaddress1 auto
